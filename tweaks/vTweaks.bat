...
reg add "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" /v "EnablleActivityFeed" /t REG_DWORD /d "0" /f
reg add "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" /v "PublishUserActivities" /t REG_DWORD /d "0" /f
reg add "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" /v "UploadUserActivities" /t REG_DWORD /d "0" /f
reg add "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" /v "DisableWindowsConsumerFeatures" /t REG_DWORD /d "1" /f
reg add "HKCU:\System\GameConfigStore" /v "GameDVR_FSEBehavior" /t REG_DWORD /d "2" /f
reg add "HKCU:\System\GameConfigStore" /v "GameDVR_Enabled" /t REG_DWORD /d "0" /f
reg add "HKCU:\System\GameConfigStore" /v "GameDVR_HonorUserFSEBehaviorMode" /t REG_DWORD /d "1" /f
reg add "HKCU:\System\GameConfigStore" /v "GameDVR_EFSEFeatureFlags" /t REG_DWORD /d "0" /f
reg add "HKLM:\SOFTWARE\Policies\Microsoft\Windows\GameDVR" /v "AllowGameDVR" /t REG_DWORD /d "0" /f
reg add "HKCU:\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v  "SettingsPageVisibility" /t REG_DWORD "hide:home" /f
reg add "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\location" /v "Value" /t REG_DWORD "deny" /f
reg add "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Sensor\Overrides\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}" /v  "SensorPermissionState" /t REG_DWORD "0" /f 
reg add "HKLM:\SYSTEM\CurrentControlSet\Services\lfsvc\Service\Configuration" /v "Status" /t REG_DWORD "0" /f
reg add "HKLM:\SYSTEM\Maps" /v "AutoUpdateEnabled" /t REG_DWORD "0" /f
reg add "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsCopilot" /v "TurnOffWindowsCopilot" /t REG_DWORD "1" /f
reg add "HKCU:\Software\Policies\Microsoft\Windows\WindowsCopilot" /v "TurnOffWindowsCopilot" /t REG_DWORD "1" /f
reg add "HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "ShowCopilotButton" /t REG_DWORD "0" /f
reg add "HKLM:\SOFTWARE\Microsoft\Windows\Shell\Copilot" /v "IsCopilotAvailable" /t REG_DWORD "0" /f
reg add "HKLM:\SOFTWARE\Microsoft\Windows\Shell\Copilot" /v  "CopilotDisabledReason" /t REG_DWORD "IsEnabledForGeographicRegionFailed" /f
reg add "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\WindowsCopilot" /v "AllowCopilotRuntime" /t REG_DWORD "0" /f
reg add "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Shell Extensions\Blocked" /v "{CB3B0003-8088-4EDE-8769-8B354AB2FF8C}" /t REG_DWORD "" /f
reg add "HKLM:\SOFTWARE\Microsoft\Windows\Shell\Copilot\BingChat" /v "IsUserEligible" /t REG_DWORD "0" /f
...
cls
echo vTweaks applied, reboot your pc.
pause